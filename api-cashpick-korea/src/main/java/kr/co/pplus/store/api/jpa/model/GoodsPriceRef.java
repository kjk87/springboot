...
@Data
@Entity(name="goodsPriceRef")
@Table(name="goods_price")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(callSuper = false)
@JsonInclude(JsonInclude.Include.NON_NULL)
public class GoodsPriceRef implements Serializable {
	...
	@Formula("(select avg(gr.eval) from goods_review gr where gr.goods_price_seq_no = seq_no)")
