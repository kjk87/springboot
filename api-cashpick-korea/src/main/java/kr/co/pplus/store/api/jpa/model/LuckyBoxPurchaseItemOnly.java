...
@Data
@Entity(name = "luckyBoxPurchaseItemOnly")
@Table(name = "luckybox_purchase_item")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class LuckyBoxPurchaseItemOnly implements Serializable {
    ...
    private Integer deliveryStatus; // 0:주문확인전, 1:배송대기(배송신청), 2:배송중, 3:배송완료
