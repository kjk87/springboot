...
@Entity(name = "luckyPickDeliveryPurchase")
@Table(name = "lucky_pick_delivery_purchase")
@Data
@JsonInclude(JsonInclude.Include.NON_NULL)
public class LuckyPickDeliveryPurchase implements Serializable {
    ...
    @JoinColumn(name = "lucky_pick_purchase_item_seq_no",  referencedColumnName="seq_no", insertable = false, updatable = false)
    LuckyPickPurchaseItemOnly luckyPickPurchaseItem = null ;
    ...
    @Transient
    LuckyPickPurchaseItemOption selectOption;

    @Transient
    LuckyPickDelivery selectDelivery;
}
