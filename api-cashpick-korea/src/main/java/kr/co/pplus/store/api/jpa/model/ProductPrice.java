...
public class ProductPrice {
    ...
    public ProductPriceOnly convert(){
        ProductPriceOnly productPriceOnly = new ProductPriceOnly();
        productPriceOnly.setSeqNo(seqNo);
        productPriceOnly.setCode(code);
        productPriceOnly.setProductSeqNo(productSeqNo);
        productPriceOnly.setPageSeqNo(pageSeqNo);
        productPriceOnly.setPrice(price);
        productPriceOnly.setOriginPrice(originPrice);
        productPriceOnly.setIsDiscount(isDiscount);
        productPriceOnly.setDiscount(discount);
        productPriceOnly.setDiscountUnit(discountUnit);
        productPriceOnly.setSupplyPrice(supplyPrice);
        productPriceOnly.setConsumerPrice(consumerPrice);
        productPriceOnly.setMaximumPrice(maximumPrice);
        productPriceOnly.setDiscountRatio(discountRatio);
        productPriceOnly.setIsLuckyball(isLuckyball);
        productPriceOnly.setMarketType(marketType);
        productPriceOnly.setRegDatetime(regDatetime);
        productPriceOnly.setStatus(status);
        productPriceOnly.setPick(pick);
        productPriceOnly.setTemp(temp);
        productPriceOnly.setIsPoint(isPoint);
        productPriceOnly.setPoint(point);
        productPriceOnly.setPointUnit(pointUnit);
        productPriceOnly.setPointPrice(pointPrice);
        productPriceOnly.setIsTicket(isTicket);
        productPriceOnly.setProductType(productType);
        productPriceOnly.setDailyCount(dailyCount);
        productPriceOnly.setStartTime(startTime);
        productPriceOnly.setEndTime(endTime);
        productPriceOnly.setDailySoldCount(dailySoldCount);
        productPriceOnly.setUnitPrice(unitPrice);
        productPriceOnly.setTimes(times);
        productPriceOnly.setRemainDays(remainDays);
        productPriceOnly.setIsSubscription(isSubscription);
        productPriceOnly.setIsPrepayment(isPrepayment);
        productPriceOnly.setPriceUrl(priceUrl);
