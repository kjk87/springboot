...
@Entity(name="buy") // This tells Hibernate to make a table out of this class
@Table(name="buy")
@Data
...
public class Buy {
    ...
    @Key
    @Column(name="type")
    Integer type = null ;  //구매 상품 타입(0 :  메뉴 상품, 1 : 일반 상품, 2: 쿠폰
    ...
    @Transient
    List<BuyGoodsSelect> buyGoodsSelectList = null ;
    ...
    Integer orderType = 0 ; //0: 매장주문, 1포장주문, 2:배달주문, 3:배송, 4:예약
