...
@Entity(name = "luckyBoxPurchaseWithItem")
@Table(name = "luckybox_purchase")
@Data
@JsonInclude(JsonInclude.Include.NON_NULL)
public class LuckyBoxPurchaseWithItem implements Serializable {
    ...
    private String title; // luckybox title
    ...
    @JoinColumn(name="luckybox_purchase_seq_no", referencedColumnName="seq_no", insertable=false, updatable=false)
    @Where(clause = "status = 2 and is_open = false")
    private Set<LuckyBoxPurchaseItemOnly> itemList;
