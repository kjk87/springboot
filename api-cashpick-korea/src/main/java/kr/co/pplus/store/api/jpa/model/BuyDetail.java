...
@Entity(name="buyDetail") // This tells Hibernate to make a table out of this class
@Table(name="buy")
@Data
...
public class BuyDetail {
    ...
    private List<BuyGoodsDetail> buyGoodsList = new ArrayList<BuyGoodsDetail>();
...
//    @Formula("(select count(*) from goods_review gr where gr.member_seq_no = member_seq_no and gr.buy_seq_no = seq_no) > 0")
