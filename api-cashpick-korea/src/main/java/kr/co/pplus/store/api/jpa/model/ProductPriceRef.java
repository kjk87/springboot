...
@Data
@Entity(name = "productPriceRef")
@Table(name = "product_price")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(callSuper = false)
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ProductPriceRef implements Serializable {
    ...
    @Formula("(select avg(pr.eval) from product_review pr where pr.product_price_seq_no = seq_no)")
    private Float avgEval = 0.0f;
