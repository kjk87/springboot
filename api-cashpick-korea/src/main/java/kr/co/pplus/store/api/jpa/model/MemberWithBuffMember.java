...
@Entity(name="memberWithBuffMember") // This tells Hibernate to make a table out of this class
@Table(name="member")
@Data
@EqualsAndHashCode(callSuper = false)
@JsonInclude(JsonInclude.Include.NON_NULL)
public class MemberWithBuffMember implements Serializable {
    ...
    @Column(name="cash")
    Long cash = null ; // '보유 캐쉬',

    @Column(name="bol")
    Float bol = null ;  // '보유 BOL',
    ...
    @JoinColumn(name="member_seq_no", insertable=false, updatable=false)
    Set<BuffMember> buffMemberList = null ;
