...
@Data
@Entity(name = "luckyBoxPurchaseItemCustom")
@Table(name = "luckybox_purchase_item")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class LuckyBoxPurchaseItemCustom implements Serializable {
    ...
    @Column(name="is_luckybox")
    private Boolean isLuckybox = false;
