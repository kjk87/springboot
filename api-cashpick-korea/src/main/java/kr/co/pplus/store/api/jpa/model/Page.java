...
@Entity(name="page") // This tells Hibernate to make a table out of this class
@Table(name="page")
@Data
...
public class Page {
    ...
    String phoneNumber  = null ; // '전화 번호',

    @Column(name="open_bounds")
    String openBounds  = null ; //`공개 범위',
    ...
    String offerResDate  = null ; // '의뢰 가능 일시',
    ...
    List<PageVirtualNumber> numberList =  new ArrayList<PageVirtualNumber>() ; // PRnumber Join하기 위해 추가
    ...
    private String storeType;// online, offline, personal
    ...
    @Column(name="business_hours_type")
