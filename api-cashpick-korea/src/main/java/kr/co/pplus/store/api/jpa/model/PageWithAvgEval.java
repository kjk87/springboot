...
@Entity(name="pageWithAvgEval") // This tells Hibernate to make a table out of this class
@Table(name="page")
@Data
...
public class PageWithAvgEval {
    ...
    @NotFound(action = NotFoundAction.IGNORE)
    @OneToOne(fetch=FetchType.EAGER, cascade = CascadeType.ALL)
    @JoinColumn(name = "category_major_seq_no", referencedColumnName = "seq_no", insertable = false, updatable = false)
